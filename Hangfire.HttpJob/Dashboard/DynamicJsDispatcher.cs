    ...
    public class DynamicJsDispatcher : IDashboardDispatcher
    {
        ...
        public Task Dispatch(DashboardContext context)
        {
            ...
            builder.Append(@"(function (hangFire) {")
                  ...
                  .AppendFormat("hangFire.httpjobConfig.NoticeDingToken = '{0}';", _options?.DingTalkOption?.NoticeDingToken ?? "")
                  .AppendFormat("hangFire.httpjobConfig.DingtalkPhones = '{0}';", _options?.DingTalkOption?.DingtalkPhones ?? "")
                  .AppendFormat("hangFire.httpjobConfig.DingtalkAtAll = '{0}';", _options?.DingTalkOption?.DingtalkAtAll ?? false ? "true" : "false")
