    ...
    public class DynamicJsDispatcher : IDashboardDispatcher
    {
        ...
        public async Task Dispatch(DashboardContext context)
        {
            ...
            builder.Append(@"(function (hangFire) {")
                   ...
                   .AppendFormat("hangFire.httpjobConfig.Remind_SelectOneJob = '{0}';", _options.Remind_SelectOneJob)
                   .AppendFormat("hangFire.httpjobConfig.Remind_Remind_SelectNoJobAgent = '{0}';", _options.Remind_SelectNoJobAgent)
                   .AppendFormat("hangFire.httpjobConfig.Remind_Warning = '{0}';", _options.Remind_Warning)
                   .AppendFormat("hangFire.httpjobConfig.Remind_StopBackgroundJob = '{0}';", _options.Remind_StopBackgroundJob)
                   .AppendFormat("hangFire.httpjobConfig.AgentJobRunningParam = '{0}';", _options.AgentJobRunningParam)
                   .AppendFormat("hangFire.httpjobConfig.Remind_StartJob = '{0}';", _options.Remind_StartJob)

                   .AppendFormat("hangFire.httpjobConfig.AgentJobRunDetailButton = '{0}';", _options.AgentJobRunDetailButton)
                   .AppendFormat("hangFire.httpjobConfig.AgentJobRunningButton = '{0}';", _options.AgentJobRunningButton)
                   .AppendFormat("hangFire.httpjobConfig.AgentJobRunningSuccess = '{0}';", _options.AgentJobRunningSuccess)
                   ...
                   .AppendFormat("hangFire.httpjobConfig.CancelButtonName = '{0}';", _options.CancelButtonName)
