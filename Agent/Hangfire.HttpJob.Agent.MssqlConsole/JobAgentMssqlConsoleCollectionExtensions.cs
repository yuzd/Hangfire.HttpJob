...
#else
        public static IAppBuilder UseJobAgentConsoleToSqlServer(this IAppBuilder app, IServiceCollection services,Action<MssqlStorageOptions> configureOptions = null)
#endif
