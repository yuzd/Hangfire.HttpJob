...
namespace Hangfire.HttpJob.Agent.Util
{
    ...
    /// </summary>
    internal class AgentThreadPoolSettings
    {
        /// <summary>
        ...
        public AgentThreadPoolSettings(int numThreads, string name = null, TimeSpan? deadlockTimeout = null, Action<Exception> exceptionHandler = null)
            : this(numThreads, DefaultThreadType, name, deadlockTimeout, exceptionHandler)
        { }

        public AgentThreadPoolSettings(int numThreads, ThreadType threadType, string name = null, TimeSpan? deadlockTimeout = null, Action<Exception> exceptionHandler = null)
        {
     ...
     /// <summary>
    /// TaskScheduler for working with a <see cref="AgentThreadPool"/> instance
    /// </summary>
    internal class AgentThreadPoolTaskScheduler : TaskScheduler
    {
        ...
        private readonly AgentThreadPool _pool;
        ...
        /// in the <see cref="AgentThreadPool"/>.
        /// </summary>
    ...
    /// </summary>
    internal sealed class AgentThreadPool : IDisposable
    {
        /// <summary>
        /// TBD
        /// </summary>
        /// <param name="settings">TBD</param>
        public AgentThreadPool(AgentThreadPoolSettings settings)
        {
        ...
        /// TBD
        /// </summary>
        public AgentThreadPoolSettings Settings { get; private set; }
